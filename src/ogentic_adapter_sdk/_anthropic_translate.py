...
in ``tests/vectors/test_anthropic_translation.py`` lock this contract.
"""
...
def _stringify(content: Any) -> str:
    ...
    plain string. Non-string content is stringified so the caller sees the
    value and can flatten upstream if needed.
    """
